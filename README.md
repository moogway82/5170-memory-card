...
- MEMW_N from ISA bus (pin C10 topside on 16-bit extension) needs to be wired to pin 1 on CPLD U36
- Pin 1 of the J5 System Control pins is now the XMS_ONLY_N switch and is either pulled high (off) or GND (on) [see below]

Switches:
- XMS_ONLY_N - '0' (GND) will only decode the Extended Memory, above 1MB. '1' (pull-high) will provide 128kb of conventional RAM above 512kb (0x08000 - 0x09FFF range).
